...
let ProjectDescriptions = [
  ...
  "Currently in development, this solo-led dungeon-crawling RPG is being built in <span style=\"color: orange; font-weight: bold;\">Unity</span> with <span style=\"color: orange; font-weight: bold;\">C#</span>, featuring procedurally generated dungeons, enemy AI behaviors, and character progression systems. I’ve implemented core gameplay systems including procedural level design, dynamic enemy logic, inventory management, and scalable player upgrades. Designed for short, replayable dungeon runs packed with secrets, traps, and loot, the game combines quick-session gameplay with long-term character growth. While primarily a solo project, I’m collaborating with artists and designers to bring the vision to life—highlighting my strengths in gameplay systems, procedural design, and end-to-end game development.",
