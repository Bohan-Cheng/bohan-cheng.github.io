...
let ProjectDescriptions = [
  ...
  "<span style=\"font-weight: bold;\">Pong! 3D</span> is a modern multiplayer reimagining of the classic Pong arcade game, built in <span style=\"color: orange; font-weight: bold;\">Unity</span> using <span style=\"color: orange; font-weight: bold;\">C#</span> for game logic and <span style=\"color: orange; font-weight: bold;\">Python</span> for server-side implementation. The game features fully 3D visuals and real-time online gameplay powered by a <span style=\"color: orange; font-weight: bold;\">dedicated server hosted on AWS</span>. I handled everything from gameplay and rendering to multiplayer architecture, client-server communication, and cloud deployment. This project demonstrates my ability to integrate game development with backend infrastructure and deliver a complete, scalable multiplayer experience.",
