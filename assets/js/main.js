...
let ProjectDescriptions = [
  ...
  "<span style=\"font-weight: bold;\">Currently in development</span>, this solo-developed dungeon-crawling RPG is being built in <span style=\"color: orange; font-weight: bold;\">Unity</span> with <span style=\"color: orange; font-weight: bold;\">C#</span>, featuring <span style=\"color: orange; font-weight: bold;\">procedurally generated dungeons</span>, <span style=\"color: orange; font-weight: bold;\">enemy AI</span>, and <span style=\"color: orange; font-weight: bold;\">player progression systems</span>. I’ve implemented core gameplay features including <span style=\"color: orange; font-weight: bold;\">procedural level design</span>, <span style=\"color: orange; font-weight: bold;\">dynamic enemy logic</span>, inventory management, and scalable upgrade mechanics. Designed for short, replayable dungeon runs packed with secrets, traps, and loot, the game combines quick-session gameplay with long-term growth. As a fully solo project, it highlights my strengths in <span style=\"color: orange; font-weight: bold;\">gameplay systems</span>, <span style=\"color: orange; font-weight: bold;\">procedural design</span>, and <span style=\"color: orange; font-weight: bold;\">end-to-end development</span>.",
  ...
  "Currently in development: Beat Hero – a fast-paced rhythm game where you block incoming beats in perfect time with the music. Precision and rhythm are your weapons as you clash with the beat in colorful, energetic levels. Just a 1-day demo for now—but it's a tight, playable core with plenty of room to grow into something big.",
  "NthState is a physics-driven puzzle game built around the idea that your environment is your only tool. Created for a game jam with the theme ‘Your environment impacts you,’ the game features a rotating world mechanic—there’s no player character, only momentum, gravity, and clever level design. Experiment with angles, collisions, and realistic bounces as you guide objects to victory through pure environmental control. A unique challenge born from deep physics tuning and creative constraint. </br></br>Play for free on itch.io : <a target=\"_blank\" href=\"https://depressedcookie.itch.io/nth-state\" style=\"color: blue;\"> Click here to play </a>",
