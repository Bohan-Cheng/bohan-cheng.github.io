...
let ProjectDescriptions = [
  ...
  "Currently in development, this solo-led dungeon-crawling RPG is being built in <span style=\"color: orange; font-weight: bold;\">Unity</span> with <span style=\"color: orange; font-weight: bold;\">C#</span>, featuring <span style=\"font-weight: bold;\">procedurally generated</span> dungeons, <span style=\"font-weight: bold;\">enemy AI</span>, and <span style=\"font-weight: bold;\">player progression systems</span>. I’ve implemented core gameplay systems including <span style=\"color: orange; font-weight: bold;\">procedural level design</span>, <span style=\"color: orange; font-weight: bold;\">dynamic enemy logic</span>, inventory management, and scalable upgrade mechanics. Designed for short, replayable dungeon runs packed with secrets, traps, and loot, the game combines quick-session gameplay with long-term growth. While primarily a solo project, I’m collaborating with artists and designers—highlighting my strengths in <span style=\"font-weight: bold;\">gameplay systems</span>, <span style=\"font-weight: bold;\">procedural design</span>, and <span style=\"font-weight: bold;\">end-to-end development</span>.",
