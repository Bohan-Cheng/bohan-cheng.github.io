...
let ProjectDescriptions = [
  "Bullet Blitz is a 2D multiplayer shooter where quick reflexes meet tactical ability play. Battle it out with friends using a variety of weapons, unique character abilities, and a distinct double jump & aerial stall(mid-air-shooting) mechanic that opens up fast, vertical movement. Tight controls, chaotic firefights, and creative mobility make every match a fast-paced, skill-driven showdown.",
