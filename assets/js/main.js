...
let ProjectDescriptions = [
  "<h3>Bullet Blitz</h3> is a 2D multiplayer shooter I developed using <em>Unity</em> and <em>C#</em>. I designed and implemented core gameplay systems, including the character controller, weapon mechanics, and the aerial mobility system (double jump + mid-air shooting). I also built and optimized online multiplayer functionality using <em>Unity Netcode</em>, ensuring responsive and competitive play. The project showcases my strengths in gameplay programming, real-time networking, and delivering tight, responsive controls in a fast-paced environment.",
