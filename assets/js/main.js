...
let ProjectDescriptions = [
  ...
  "<span style=\"font-weight: bold;\">LuvBug Learning</span> is an educational game platform centered on social-emotional learning for kids. I contributed to the development of a platform-wide <span style=\"color: orange; font-weight: bold;\">checkpoint and progress-tracking system</span> to improve player retention and engagement. I also implemented <span style=\"color: orange; font-weight: bold;\">gameplay features</span> across multiple mini-games, supporting interactive learning through responsive mechanics and kid-friendly UX. Built using <span style=\"color: orange; font-weight: bold;\">Unity</span> and <span style=\"color: orange; font-weight: bold;\">C#</span>, this project highlights my ability to build scalable systems and collaborate on educational game design.",
