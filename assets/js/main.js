...
let ProjectDescriptions = [
  ...
  "<span style=\"font-weight: bold;\">Currently in development</span>, this solo-developed dungeon-crawling RPG is being built in <span style=\"color: orange;\">Unity</span> with <span style=\"color: orange;\">C#</span>, featuring procedurally generated dungeons, enemy AI, and player progression systems. I’ve implemented core gameplay features including <span style=\"color: orange;\">procedural level design</span>, <span style=\"color: orange;\">dynamic enemy logic</span>, inventory management, and scalable upgrade mechanics. Designed for short, replayable dungeon runs packed with secrets, traps, and loot, the game combines quick-session gameplay with long-term growth. As a fully solo project, it highlights my strengths in gameplay systems, procedural design, and end-to-end development.",
